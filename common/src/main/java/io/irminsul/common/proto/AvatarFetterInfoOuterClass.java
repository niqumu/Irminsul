...
public final class AvatarFetterInfoOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      AvatarFetterInfoOuterClass.class.getName());
  }
  ...
  public interface AvatarFetterInfoOrBuilder extends
     ...
     */
    java.util.List<Integer> getOpenIdListList();
    /**
     * <code>repeated uint32 open_id_list = 3;</code>
     ...
     */
    java.util.List<Integer> getFinishIdListList();
    /**
     * <code>repeated uint32 finish_id_list = 4;</code>
     ...
     */
    java.util.List<Integer> getRewardedFetterLevelListList();
    /**
     * <code>repeated uint32 rewarded_fetter_level_list = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        AvatarFetterInfo.class.getName());
    }
    // Use AvatarFetterInfo.newBuilder() to construct.
    private AvatarFetterInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarFetterInfo.class, Builder.class);
    }
    ...
    public static AvatarFetterInfo parseFrom(
    ...
    public static AvatarFetterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarFetterInfo parseFrom(
    ...
    public static AvatarFetterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarFetterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static AvatarFetterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.AvatarFetterInfoOuterClass.AvatarFetterInfo.newBuilder()
      private Builder() {
      ...
      private void buildPartialRepeatedFields(AvatarFetterInfo result) {
        if (fetterListBuilder_ == null) {
      ...
      private void buildPartial0(AvatarFetterInfo result) {
      ...
      public Builder mergeFrom(AvatarFetterInfo other) {
        if (other == AvatarFetterInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                FetterDataOuterClass.FetterData m =
                    input.readMessage(
                        FetterDataOuterClass.FetterData.parser(),
                        extensionRegistry);
                if (fetterListBuilder_ == null) {
                  ensureFetterListIsMutable();
                  fetterList_.add(m);
      ...
      public Builder addAllFetterList(
          Iterable<? extends FetterDataOuterClass.FetterData> values) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, fetterList_);
      ...
      private com.google.protobuf.RepeatedFieldBuilder<
        ...
        if (fetterListBuilder_ == null) {
          fetterListBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              FetterDataOuterClass.FetterData, FetterDataOuterClass.FetterData.Builder, FetterDataOuterClass.FetterDataOrBuilder>(
                  fetterList_,
  ...
  static {
    String[] descriptorData = {
      ...
      "\006 \003(\0132\013.FetterDataB\032\n\030io.irminsul.common" +
      ".protob\006proto3"
    };
    ...
    internal_static_AvatarFetterInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_AvatarFetterInfo_descriptor,
        new String[] { "ExpNumber", "ExpLevel", "OpenIdList", "FinishIdList", "RewardedFetterLevelList", "FetterList", });
