...
public final class ClientGadgetInfoOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      ClientGadgetInfoOuterClass.class.getName());
  }
  ...
  public interface ClientGadgetInfoOrBuilder extends
     ...
     */
    java.util.List<Integer> getTargetEntityIdListList();
    /**
     * <code>repeated uint32 target_entity_id_list = 8;</code>
     ...
     */
    java.util.List<Integer> getTargetLockPointIndexListList();
    /**
     * <code>repeated uint32 target_lock_point_index_list = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        ClientGadgetInfo.class.getName());
    }
    // Use ClientGadgetInfo.newBuilder() to construct.
    private ClientGadgetInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return ClientGadgetInfoOuterClass.internal_static_ClientGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ClientGadgetInfo.class, Builder.class);
    }
    ...
    public static ClientGadgetInfo parseFrom(
    ...
    public static ClientGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ClientGadgetInfo parseFrom(
    ...
    public static ClientGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ClientGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static ClientGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.ClientGadgetInfoOuterClass.ClientGadgetInfo.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(ClientGadgetInfo result) {
      ...
      public Builder mergeFrom(ClientGadgetInfo other) {
        if (other == ClientGadgetInfo.getDefaultInstance()) return this;
  ...
  static {
    String[] descriptorData = {
      ...
      "lock_point_index_list\030\t \003(\rB\032\n\030io.irmins" +
    ...
    internal_static_ClientGadgetInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_ClientGadgetInfo_descriptor,
        new String[] { "CampId", "CampType", "Guid", "OwnerEntityId", "TargetEntityId", "AsyncLoad", "IsPeerIdFromPlayer", "TargetEntityIdList", "TargetLockPointIndexList", });
