...
public final class MonsterRouteOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      MonsterRouteOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        MonsterRoute.class.getName());
    }
    // Use MonsterRoute.newBuilder() to construct.
    private MonsterRoute(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return MonsterRouteOuterClass.internal_static_MonsterRoute_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MonsterRoute.class, Builder.class);
    }
    ...
    public static MonsterRoute parseFrom(
    ...
    public static MonsterRoute parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MonsterRoute parseFrom(
    ...
    public static MonsterRoute parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MonsterRoute parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static MonsterRoute parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.MonsterRouteOuterClass.MonsterRoute.newBuilder()
      private Builder() {
      ...
      private void buildPartialRepeatedFields(MonsterRoute result) {
        if (routePointsBuilder_ == null) {
      ...
      private void buildPartial0(MonsterRoute result) {
      ...
      public Builder mergeFrom(MonsterRoute other) {
        if (other == MonsterRoute.getDefaultInstance()) return this;
        if (routePointsBuilder_ == null) {
  ...
  static {
    String[] descriptorData = {
      ...
      "type\030\003 \001(\r\022\024\n\014arrive_range\030\004 \001(\002B\032\n\030io.i" +
    ...
    internal_static_MonsterRoute_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_MonsterRoute_descriptor,
        new String[] { "RoutePoints", "SpeedLevel", "RouteType", "ArriveRange", });
