...
public final class AbilityAppliedModifierOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      AbilityAppliedModifierOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        AbilityAppliedModifier.class.getName());
    }
    // Use AbilityAppliedModifier.newBuilder() to construct.
    private AbilityAppliedModifier(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return AbilityAppliedModifierOuterClass.internal_static_AbilityAppliedModifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AbilityAppliedModifier.class, Builder.class);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (Float.floatToRawIntBits(existDuration_) != 0) {
    ...
    public boolean equals(final Object obj) {
      ...
      if (Float.floatToIntBits(getExistDuration())
    ...
    public static AbilityAppliedModifier parseFrom(
    ...
    public static AbilityAppliedModifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AbilityAppliedModifier parseFrom(
    ...
    public static AbilityAppliedModifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AbilityAppliedModifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static AbilityAppliedModifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(AbilityAppliedModifier result) {
      ...
      public Builder mergeFrom(AbilityAppliedModifier other) {
        if (other == AbilityAppliedModifier.getDefaultInstance()) return this;
      ...
      public Builder mergeParentAbilityName(AbilityStringOuterClass.AbilityString value) {
        if (parentAbilityNameBuilder_ == null) {
          if (((bitField0_ & 0x00000004) != 0) &&
            parentAbilityName_ != null &&
            parentAbilityName_ != AbilityStringOuterClass.AbilityString.getDefaultInstance()) {
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getParentAbilityNameFieldBuilder() {
        if (parentAbilityNameBuilder_ == null) {
          parentAbilityNameBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              AbilityStringOuterClass.AbilityString, AbilityStringOuterClass.AbilityString.Builder, AbilityStringOuterClass.AbilityStringOrBuilder>(
      ...
      public Builder mergeParentAbilityOverride(AbilityStringOuterClass.AbilityString value) {
        if (parentAbilityOverrideBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0) &&
            parentAbilityOverride_ != null &&
            parentAbilityOverride_ != AbilityStringOuterClass.AbilityString.getDefaultInstance()) {
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getParentAbilityOverrideFieldBuilder() {
        if (parentAbilityOverrideBuilder_ == null) {
          parentAbilityOverrideBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              AbilityStringOuterClass.AbilityString, AbilityStringOuterClass.AbilityString.Builder, AbilityStringOuterClass.AbilityStringOrBuilder>(
      ...
      public Builder mergeAttachedInstancedModifier(AbilityAttachedModifierOuterClass.AbilityAttachedModifier value) {
        if (attachedInstancedModifierBuilder_ == null) {
          if (((bitField0_ & 0x00000080) != 0) &&
            attachedInstancedModifier_ != null &&
            attachedInstancedModifier_ != AbilityAttachedModifierOuterClass.AbilityAttachedModifier.getDefaultInstance()) {
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getAttachedInstancedModifierFieldBuilder() {
        if (attachedInstancedModifierBuilder_ == null) {
          attachedInstancedModifierBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              AbilityAttachedModifierOuterClass.AbilityAttachedModifier, AbilityAttachedModifierOuterClass.AbilityAttachedModifier.Builder, AbilityAttachedModifierOuterClass.AbilityAttachedModifierOrBuilder>(
      ...
      public Builder mergeModifierDurability(ModifierDurabilityOuterClass.ModifierDurability value) {
        if (modifierDurabilityBuilder_ == null) {
          if (((bitField0_ & 0x00000400) != 0) &&
            modifierDurability_ != null &&
            modifierDurability_ != ModifierDurabilityOuterClass.ModifierDurability.getDefaultInstance()) {
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getModifierDurabilityFieldBuilder() {
        if (modifierDurabilityBuilder_ == null) {
          modifierDurabilityBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              ModifierDurabilityOuterClass.ModifierDurability, ModifierDurabilityOuterClass.ModifierDurability.Builder, ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder>(
  ...
  static {
    ...
    internal_static_AbilityAppliedModifier_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_AbilityAppliedModifier_descriptor,
        new String[] { "ModifierLocalId", "ParentAbilityEntityId", "ParentAbilityName", "ParentAbilityOverride", "InstancedAbilityId", "InstancedModifierId", "ExistDuration", "AttachedInstancedModifier", "ApplyEntityId", "IsAttachedParentAbility", "ModifierDurability", "SbuffUid", "IsServerbuffModifier", });
