...
public final class EnterSceneReadyRspOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      EnterSceneReadyRspOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        EnterSceneReadyRsp.class.getName());
    }
    // Use EnterSceneReadyRsp.newBuilder() to construct.
    private EnterSceneReadyRsp(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return EnterSceneReadyRspOuterClass.internal_static_EnterSceneReadyRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EnterSceneReadyRsp.class, Builder.class);
    }
    ...
    public static EnterSceneReadyRsp parseFrom(
    ...
    public static EnterSceneReadyRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EnterSceneReadyRsp parseFrom(
    ...
    public static EnterSceneReadyRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EnterSceneReadyRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static EnterSceneReadyRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.EnterSceneReadyRspOuterClass.EnterSceneReadyRsp.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(EnterSceneReadyRsp result) {
      ...
      public Builder mergeFrom(EnterSceneReadyRsp other) {
        if (other == EnterSceneReadyRsp.getDefaultInstance()) return this;
