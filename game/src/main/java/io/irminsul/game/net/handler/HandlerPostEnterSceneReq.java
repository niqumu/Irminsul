...
import io.irminsul.game.net.packet.PacketPostEnterSceneRsp;

public class HandlerPostEnterSceneReq implements PacketHandler {
    ...
    public int getTargetID() {
        return PacketIds.PostEnterSceneReq;
    }
    ...
    public void handle(InboundPacket packet, Session session) throws Exception {
        new PacketPostEnterSceneRsp(session).send();
    }
}
