...
public final class SceneGadgetInfoOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      SceneGadgetInfoOuterClass.class.getName());
  }
  ...
  public interface SceneGadgetInfoOrBuilder extends
     ...
     */
    TrifleGadgetOuterClass.TrifleGadget getTrifleGadget();
    /**
     * <code>.TrifleGadget trifle_gadget = 67;</code>
     */
    TrifleGadgetOuterClass.TrifleGadgetOrBuilder getTrifleGadgetOrBuilder();
     ...
     */
    java.util.List<Integer> getInteractUidListList();
    /**
     * <code>repeated uint32 interact_uid_list = 24;</code>
     ...
     */
    JMFPBNKNHEDOuterClass.JMFPBNKNHED getGPOHBBPBBEC();
    /**
     * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
     */
    JMFPBNKNHEDOuterClass.JMFPBNKNHEDOrBuilder getGPOHBBPBBECOrBuilder();
     ...
     */
    GDGKKLFMJKHOuterClass.GDGKKLFMJKH getDPJFGJDHGGJ();
    /**
     * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
     */
    GDGKKLFMJKHOuterClass.GDGKKLFMJKHOrBuilder getDPJFGJDHGGJOrBuilder();
     ...
     */
    OMBIJJLAHFBOuterClass.OMBIJJLAHFB getPBBAFKFGHIB();
    /**
     * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
     */
    OMBIJJLAHFBOuterClass.OMBIJJLAHFBOrBuilder getPBBAFKFGHIBOrBuilder();
     ...
     */
    BDOCPDNCIEFOuterClass.BDOCPDNCIEF getFDKBHOCNBPH();
    /**
     * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
     */
    BDOCPDNCIEFOuterClass.BDOCPDNCIEFOrBuilder getFDKBHOCNBPHOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        SceneGadgetInfo.class.getName());
    }
    // Use SceneGadgetInfo.newBuilder() to construct.
    private SceneGadgetInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return SceneGadgetInfoOuterClass.internal_static_SceneGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SceneGadgetInfo.class, Builder.class);
    }
     ...
     * @return The bornType.
     */
    @Override public GadgetBornTypeOuterClass.GadgetBornType getBornType() {
      GadgetBornTypeOuterClass.GadgetBornType result = GadgetBornTypeOuterClass.GadgetBornType.forNumber(bornType_);
    ...
    public GatherGadgetInfoOuterClass.GatherGadgetInfo getGatherGadget() {
      if (contentCase_ == 13) {
         return (GatherGadgetInfoOuterClass.GatherGadgetInfo) content_;
      }
    ...
    public WorktopInfoOuterClass.WorktopInfo getWorktop() {
      if (contentCase_ == 14) {
         return (WorktopInfoOuterClass.WorktopInfo) content_;
      }
    ...
    public ClientGadgetInfoOuterClass.ClientGadgetInfo getClientGadget() {
      if (contentCase_ == 15) {
         return (ClientGadgetInfoOuterClass.ClientGadgetInfo) content_;
      }
    ...
    public WeatherInfoOuterClass.WeatherInfo getWeather() {
      if (contentCase_ == 17) {
         return (WeatherInfoOuterClass.WeatherInfo) content_;
      }
    ...
    public AbilityGadgetInfoOuterClass.AbilityGadgetInfo getAbilityGadget() {
      if (contentCase_ == 18) {
         return (AbilityGadgetInfoOuterClass.AbilityGadgetInfo) content_;
      }
    ...
    public StatueGadgetInfoOuterClass.StatueGadgetInfo getStatueGadget() {
      if (contentCase_ == 19) {
         return (StatueGadgetInfoOuterClass.StatueGadgetInfo) content_;
      }
    ...
    public BossChestInfoOuterClass.BossChestInfo getBossChest() {
      if (contentCase_ == 20) {
         return (BossChestInfoOuterClass.BossChestInfo) content_;
      }
    ...
    public BlossomChestInfoOuterClass.BlossomChestInfo getBlossomChest() {
      if (contentCase_ == 41) {
         return (BlossomChestInfoOuterClass.BlossomChestInfo) content_;
      }
    ...
    public MpPlayRewardInfoOuterClass.MpPlayRewardInfo getMpPlayReward() {
      if (contentCase_ == 42) {
         return (MpPlayRewardInfoOuterClass.MpPlayRewardInfo) content_;
      }
    ...
    public GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo getGeneralReward() {
      if (contentCase_ == 43) {
         return (GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) content_;
      }
    ...
    public OfferingInfoOuterClass.OfferingInfo getOfferingInfo() {
      if (contentCase_ == 44) {
         return (OfferingInfoOuterClass.OfferingInfo) content_;
      }
    ...
    public FoundationInfoOuterClass.FoundationInfo getFoundationInfo() {
      if (contentCase_ == 45) {
         return (FoundationInfoOuterClass.FoundationInfo) content_;
      }
    ...
    public VehicleInfoOuterClass.VehicleInfo getVehicleInfo() {
      if (contentCase_ == 46) {
         return (VehicleInfoOuterClass.VehicleInfo) content_;
      }
    ...
    public EchoShellInfoOuterClass.EchoShellInfo getShellInfo() {
      if (contentCase_ == 47) {
         return (EchoShellInfoOuterClass.EchoShellInfo) content_;
      }
    ...
    public ScreenInfoOuterClass.ScreenInfo getScreenInfo() {
      if (contentCase_ == 48) {
         return (ScreenInfoOuterClass.ScreenInfo) content_;
      }
    ...
    public FishPoolInfoOuterClass.FishPoolInfo getFishPoolInfo() {
      if (contentCase_ == 59) {
         return (FishPoolInfoOuterClass.FishPoolInfo) content_;
      }
    ...
    public CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo getCustomGadgetTreeInfo() {
      if (contentCase_ == 60) {
         return (CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) content_;
      }
    ...
    public RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo getRoguelikeGadgetInfo() {
      if (contentCase_ == 61) {
         return (RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo) content_;
      }
    ...
    public NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo getNightCrowGadgetInfo() {
      if (contentCase_ == 62) {
         return (NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) content_;
      }
    ...
    public DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo getDeshretObeliskGadgetInfo() {
      if (contentCase_ == 63) {
         return (DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo) content_;
      }
    ...
    public CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo getCoinCollectOperatorInfo() {
      if (contentCase_ == 64) {
         return (CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo) content_;
      }
     ...
     */
    @Override
    public TrifleGadgetOuterClass.TrifleGadget getTrifleGadget() {
      if (contentCase_ == 67) {
         return (TrifleGadgetOuterClass.TrifleGadget) content_;
      }
      return TrifleGadgetOuterClass.TrifleGadget.getDefaultInstance();
    }
    /**
     * <code>.TrifleGadget trifle_gadget = 67;</code>
     */
    @Override
    public TrifleGadgetOuterClass.TrifleGadgetOrBuilder getTrifleGadgetOrBuilder() {
      if (contentCase_ == 67) {
         return (TrifleGadgetOuterClass.TrifleGadget) content_;
      }
      return TrifleGadgetOuterClass.TrifleGadget.getDefaultInstance();
    ...
    private JMFPBNKNHEDOuterClass.JMFPBNKNHED gPOHBBPBBEC_;
    /**
     * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
     * @return Whether the gPOHBBPBBEC field is set.
     */
     ...
     */
    @Override
    public JMFPBNKNHEDOuterClass.JMFPBNKNHED getGPOHBBPBBEC() {
      return gPOHBBPBBEC_ == null ? JMFPBNKNHEDOuterClass.JMFPBNKNHED.getDefaultInstance() : gPOHBBPBBEC_;
    }
    /**
     * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
     */
    @Override
    public JMFPBNKNHEDOuterClass.JMFPBNKNHEDOrBuilder getGPOHBBPBBECOrBuilder() {
      return gPOHBBPBBEC_ == null ? JMFPBNKNHEDOuterClass.JMFPBNKNHED.getDefaultInstance() : gPOHBBPBBEC_;
    }
    ...
    private GDGKKLFMJKHOuterClass.GDGKKLFMJKH dPJFGJDHGGJ_;
    /**
     * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
     * @return Whether the dPJFGJDHGGJ field is set.
     */
     ...
     */
    @Override
    public GDGKKLFMJKHOuterClass.GDGKKLFMJKH getDPJFGJDHGGJ() {
      return dPJFGJDHGGJ_ == null ? GDGKKLFMJKHOuterClass.GDGKKLFMJKH.getDefaultInstance() : dPJFGJDHGGJ_;
    }
    /**
     * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
     */
    @Override
    public GDGKKLFMJKHOuterClass.GDGKKLFMJKHOrBuilder getDPJFGJDHGGJOrBuilder() {
      return dPJFGJDHGGJ_ == null ? GDGKKLFMJKHOuterClass.GDGKKLFMJKH.getDefaultInstance() : dPJFGJDHGGJ_;
    }

    public static final int PBBAFKFGHIB_FIELD_NUMBER = 102;
    private OMBIJJLAHFBOuterClass.OMBIJJLAHFB pBBAFKFGHIB_;
    /**
     * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
     * @return Whether the pBBAFKFGHIB field is set.
     */
     ...
     */
    @Override
    public OMBIJJLAHFBOuterClass.OMBIJJLAHFB getPBBAFKFGHIB() {
      return pBBAFKFGHIB_ == null ? OMBIJJLAHFBOuterClass.OMBIJJLAHFB.getDefaultInstance() : pBBAFKFGHIB_;
    }
    /**
     * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
     */
    @Override
    public OMBIJJLAHFBOuterClass.OMBIJJLAHFBOrBuilder getPBBAFKFGHIBOrBuilder() {
      return pBBAFKFGHIB_ == null ? OMBIJJLAHFBOuterClass.OMBIJJLAHFB.getDefaultInstance() : pBBAFKFGHIB_;
    }

    public static final int FDKBHOCNBPH_FIELD_NUMBER = 103;
    private BDOCPDNCIEFOuterClass.BDOCPDNCIEF fDKBHOCNBPH_;
    /**
     * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
     * @return Whether the fDKBHOCNBPH field is set.
     */
     ...
     */
    @Override
    public BDOCPDNCIEFOuterClass.BDOCPDNCIEF getFDKBHOCNBPH() {
      return fDKBHOCNBPH_ == null ? BDOCPDNCIEFOuterClass.BDOCPDNCIEF.getDefaultInstance() : fDKBHOCNBPH_;
    }
    /**
     * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
     */
    @Override
    public BDOCPDNCIEFOuterClass.BDOCPDNCIEFOrBuilder getFDKBHOCNBPHOrBuilder() {
      return fDKBHOCNBPH_ == null ? BDOCPDNCIEFOuterClass.BDOCPDNCIEF.getDefaultInstance() : fDKBHOCNBPH_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (contentCase_ == 13) {
        output.writeMessage(13, (GatherGadgetInfoOuterClass.GatherGadgetInfo) content_);
      }
      if (contentCase_ == 14) {
        output.writeMessage(14, (WorktopInfoOuterClass.WorktopInfo) content_);
      }
      if (contentCase_ == 15) {
        output.writeMessage(15, (ClientGadgetInfoOuterClass.ClientGadgetInfo) content_);
      }
      if (contentCase_ == 17) {
        output.writeMessage(17, (WeatherInfoOuterClass.WeatherInfo) content_);
      }
      if (contentCase_ == 18) {
        output.writeMessage(18, (AbilityGadgetInfoOuterClass.AbilityGadgetInfo) content_);
      }
      if (contentCase_ == 19) {
        output.writeMessage(19, (StatueGadgetInfoOuterClass.StatueGadgetInfo) content_);
      }
      if (contentCase_ == 20) {
        output.writeMessage(20, (BossChestInfoOuterClass.BossChestInfo) content_);
      }
      if (markFlag_ != 0) {
      ...
      if (contentCase_ == 41) {
        output.writeMessage(41, (BlossomChestInfoOuterClass.BlossomChestInfo) content_);
      }
      if (contentCase_ == 42) {
        output.writeMessage(42, (MpPlayRewardInfoOuterClass.MpPlayRewardInfo) content_);
      }
      if (contentCase_ == 43) {
        output.writeMessage(43, (GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) content_);
      }
      if (contentCase_ == 44) {
        output.writeMessage(44, (OfferingInfoOuterClass.OfferingInfo) content_);
      }
      if (contentCase_ == 45) {
        output.writeMessage(45, (FoundationInfoOuterClass.FoundationInfo) content_);
      }
      if (contentCase_ == 46) {
        output.writeMessage(46, (VehicleInfoOuterClass.VehicleInfo) content_);
      }
      if (contentCase_ == 47) {
        output.writeMessage(47, (EchoShellInfoOuterClass.EchoShellInfo) content_);
      }
      if (contentCase_ == 48) {
        output.writeMessage(48, (ScreenInfoOuterClass.ScreenInfo) content_);
      }
      if (contentCase_ == 59) {
        output.writeMessage(59, (FishPoolInfoOuterClass.FishPoolInfo) content_);
      }
      if (contentCase_ == 60) {
        output.writeMessage(60, (CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) content_);
      }
      if (contentCase_ == 61) {
        output.writeMessage(61, (RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo) content_);
      }
      if (contentCase_ == 62) {
        output.writeMessage(62, (NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) content_);
      }
      if (contentCase_ == 63) {
        output.writeMessage(63, (DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo) content_);
      }
      if (contentCase_ == 64) {
        output.writeMessage(64, (CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo) content_);
      }
      if (contentCase_ == 67) {
        output.writeMessage(67, (TrifleGadgetOuterClass.TrifleGadget) content_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (contentCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (GatherGadgetInfoOuterClass.GatherGadgetInfo) content_);
      }
      if (contentCase_ == 14) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, (WorktopInfoOuterClass.WorktopInfo) content_);
      }
      if (contentCase_ == 15) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, (ClientGadgetInfoOuterClass.ClientGadgetInfo) content_);
      }
      if (contentCase_ == 17) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(17, (WeatherInfoOuterClass.WeatherInfo) content_);
      }
      if (contentCase_ == 18) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(18, (AbilityGadgetInfoOuterClass.AbilityGadgetInfo) content_);
      }
      if (contentCase_ == 19) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(19, (StatueGadgetInfoOuterClass.StatueGadgetInfo) content_);
      }
      if (contentCase_ == 20) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(20, (BossChestInfoOuterClass.BossChestInfo) content_);
      }
      if (markFlag_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (contentCase_ == 41) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(41, (BlossomChestInfoOuterClass.BlossomChestInfo) content_);
      }
      if (contentCase_ == 42) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(42, (MpPlayRewardInfoOuterClass.MpPlayRewardInfo) content_);
      }
      if (contentCase_ == 43) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(43, (GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) content_);
      }
      if (contentCase_ == 44) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(44, (OfferingInfoOuterClass.OfferingInfo) content_);
      }
      if (contentCase_ == 45) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(45, (FoundationInfoOuterClass.FoundationInfo) content_);
      }
      if (contentCase_ == 46) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(46, (VehicleInfoOuterClass.VehicleInfo) content_);
      }
      if (contentCase_ == 47) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(47, (EchoShellInfoOuterClass.EchoShellInfo) content_);
      }
      if (contentCase_ == 48) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(48, (ScreenInfoOuterClass.ScreenInfo) content_);
      }
      if (contentCase_ == 59) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(59, (FishPoolInfoOuterClass.FishPoolInfo) content_);
      }
      if (contentCase_ == 60) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(60, (CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) content_);
      }
      if (contentCase_ == 61) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(61, (RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo) content_);
      }
      if (contentCase_ == 62) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(62, (NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) content_);
      }
      if (contentCase_ == 63) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(63, (DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo) content_);
      }
      if (contentCase_ == 64) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(64, (CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo) content_);
      }
      if (contentCase_ == 67) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(67, (TrifleGadgetOuterClass.TrifleGadget) content_);
      }
      if (((bitField0_ & 0x00000004) != 0)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static SceneGadgetInfo parseFrom(
    ...
    public static SceneGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SceneGadgetInfo parseFrom(
    ...
    public static SceneGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SceneGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static SceneGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.SceneGadgetInfoOuterClass.SceneGadgetInfo.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(SceneGadgetInfo result) {
      ...
      private void buildPartial1(SceneGadgetInfo result) {
      ...
      private void buildPartialOneofs(SceneGadgetInfo result) {
      ...
      public Builder mergeFrom(SceneGadgetInfo other) {
        if (other == SceneGadgetInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilder<
          GatherGadgetInfoOuterClass.GatherGadgetInfo, GatherGadgetInfoOuterClass.GatherGadgetInfo.Builder, GatherGadgetInfoOuterClass.GatherGadgetInfoOrBuilder> gatherGadgetBuilder_;
      /**
       * <code>.GatherGadgetInfo gather_gadget = 13;</code>
       * @return Whether the gatherGadget field is set.
       */
      ...
      public Builder setGatherGadget(
          GatherGadgetInfoOuterClass.GatherGadgetInfo.Builder builderForValue) {
        if (gatherGadgetBuilder_ == null) {
      ...
      public Builder mergeGatherGadget(GatherGadgetInfoOuterClass.GatherGadgetInfo value) {
        if (gatherGadgetBuilder_ == null) {
          if (contentCase_ == 13 &&
              content_ != GatherGadgetInfoOuterClass.GatherGadgetInfo.getDefaultInstance()) {
            content_ = GatherGadgetInfoOuterClass.GatherGadgetInfo.newBuilder((GatherGadgetInfoOuterClass.GatherGadgetInfo) content_)
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          GatherGadgetInfoOuterClass.GatherGadgetInfo, GatherGadgetInfoOuterClass.GatherGadgetInfo.Builder, GatherGadgetInfoOuterClass.GatherGadgetInfoOrBuilder>
          getGatherGadgetFieldBuilder() {
        if (gatherGadgetBuilder_ == null) {
          if (!(contentCase_ == 13)) {
            content_ = GatherGadgetInfoOuterClass.GatherGadgetInfo.getDefaultInstance();
          }
          gatherGadgetBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              GatherGadgetInfoOuterClass.GatherGadgetInfo, GatherGadgetInfoOuterClass.GatherGadgetInfo.Builder, GatherGadgetInfoOuterClass.GatherGadgetInfoOrBuilder>(
                  (GatherGadgetInfoOuterClass.GatherGadgetInfo) content_,
      ...
      private com.google.protobuf.SingleFieldBuilder<
          WorktopInfoOuterClass.WorktopInfo, WorktopInfoOuterClass.WorktopInfo.Builder, WorktopInfoOuterClass.WorktopInfoOrBuilder> worktopBuilder_;
      /**
       * <code>.WorktopInfo worktop = 14;</code>
       * @return Whether the worktop field is set.
       */
      ...
      public Builder setWorktop(
          WorktopInfoOuterClass.WorktopInfo.Builder builderForValue) {
        if (worktopBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeWorktop(WorktopInfoOuterClass.WorktopInfo value) {
        if (worktopBuilder_ == null) {
          if (contentCase_ == 14 &&
              content_ != WorktopInfoOuterClass.WorktopInfo.getDefaultInstance()) {
            content_ = WorktopInfoOuterClass.WorktopInfo.newBuilder((WorktopInfoOuterClass.WorktopInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          WorktopInfoOuterClass.WorktopInfo, WorktopInfoOuterClass.WorktopInfo.Builder, WorktopInfoOuterClass.WorktopInfoOrBuilder>
          getWorktopFieldBuilder() {
        if (worktopBuilder_ == null) {
          if (!(contentCase_ == 14)) {
            content_ = WorktopInfoOuterClass.WorktopInfo.getDefaultInstance();
          }
          worktopBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              WorktopInfoOuterClass.WorktopInfo, WorktopInfoOuterClass.WorktopInfo.Builder, WorktopInfoOuterClass.WorktopInfoOrBuilder>(
                  (WorktopInfoOuterClass.WorktopInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ClientGadgetInfoOuterClass.ClientGadgetInfo, ClientGadgetInfoOuterClass.ClientGadgetInfo.Builder, ClientGadgetInfoOuterClass.ClientGadgetInfoOrBuilder> clientGadgetBuilder_;
      /**
       * <code>.ClientGadgetInfo client_gadget = 15;</code>
       * @return Whether the clientGadget field is set.
       */
      ...
      public Builder setClientGadget(
          ClientGadgetInfoOuterClass.ClientGadgetInfo.Builder builderForValue) {
        if (clientGadgetBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeClientGadget(ClientGadgetInfoOuterClass.ClientGadgetInfo value) {
        if (clientGadgetBuilder_ == null) {
          if (contentCase_ == 15 &&
              content_ != ClientGadgetInfoOuterClass.ClientGadgetInfo.getDefaultInstance()) {
            content_ = ClientGadgetInfoOuterClass.ClientGadgetInfo.newBuilder((ClientGadgetInfoOuterClass.ClientGadgetInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          ClientGadgetInfoOuterClass.ClientGadgetInfo, ClientGadgetInfoOuterClass.ClientGadgetInfo.Builder, ClientGadgetInfoOuterClass.ClientGadgetInfoOrBuilder>
          getClientGadgetFieldBuilder() {
        if (clientGadgetBuilder_ == null) {
          if (!(contentCase_ == 15)) {
            content_ = ClientGadgetInfoOuterClass.ClientGadgetInfo.getDefaultInstance();
          }
          clientGadgetBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              ClientGadgetInfoOuterClass.ClientGadgetInfo, ClientGadgetInfoOuterClass.ClientGadgetInfo.Builder, ClientGadgetInfoOuterClass.ClientGadgetInfoOrBuilder>(
                  (ClientGadgetInfoOuterClass.ClientGadgetInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          WeatherInfoOuterClass.WeatherInfo, WeatherInfoOuterClass.WeatherInfo.Builder, WeatherInfoOuterClass.WeatherInfoOrBuilder> weatherBuilder_;
      /**
       * <code>.WeatherInfo weather = 17;</code>
       * @return Whether the weather field is set.
       */
      ...
      public Builder setWeather(
          WeatherInfoOuterClass.WeatherInfo.Builder builderForValue) {
        if (weatherBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeWeather(WeatherInfoOuterClass.WeatherInfo value) {
        if (weatherBuilder_ == null) {
          if (contentCase_ == 17 &&
              content_ != WeatherInfoOuterClass.WeatherInfo.getDefaultInstance()) {
            content_ = WeatherInfoOuterClass.WeatherInfo.newBuilder((WeatherInfoOuterClass.WeatherInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          WeatherInfoOuterClass.WeatherInfo, WeatherInfoOuterClass.WeatherInfo.Builder, WeatherInfoOuterClass.WeatherInfoOrBuilder>
        ...
        if (weatherBuilder_ == null) {
          ...
          weatherBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              WeatherInfoOuterClass.WeatherInfo, WeatherInfoOuterClass.WeatherInfo.Builder, WeatherInfoOuterClass.WeatherInfoOrBuilder>(
                  (WeatherInfoOuterClass.WeatherInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          AbilityGadgetInfoOuterClass.AbilityGadgetInfo, AbilityGadgetInfoOuterClass.AbilityGadgetInfo.Builder, AbilityGadgetInfoOuterClass.AbilityGadgetInfoOrBuilder> abilityGadgetBuilder_;
      /**
       * <code>.AbilityGadgetInfo ability_gadget = 18;</code>
       * @return Whether the abilityGadget field is set.
       */
      ...
      public Builder setAbilityGadget(
          AbilityGadgetInfoOuterClass.AbilityGadgetInfo.Builder builderForValue) {
        if (abilityGadgetBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeAbilityGadget(AbilityGadgetInfoOuterClass.AbilityGadgetInfo value) {
        if (abilityGadgetBuilder_ == null) {
          if (contentCase_ == 18 &&
              content_ != AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance()) {
            content_ = AbilityGadgetInfoOuterClass.AbilityGadgetInfo.newBuilder((AbilityGadgetInfoOuterClass.AbilityGadgetInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          AbilityGadgetInfoOuterClass.AbilityGadgetInfo, AbilityGadgetInfoOuterClass.AbilityGadgetInfo.Builder, AbilityGadgetInfoOuterClass.AbilityGadgetInfoOrBuilder>
          getAbilityGadgetFieldBuilder() {
        if (abilityGadgetBuilder_ == null) {
          if (!(contentCase_ == 18)) {
            content_ = AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance();
          }
          abilityGadgetBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              AbilityGadgetInfoOuterClass.AbilityGadgetInfo, AbilityGadgetInfoOuterClass.AbilityGadgetInfo.Builder, AbilityGadgetInfoOuterClass.AbilityGadgetInfoOrBuilder>(
                  (AbilityGadgetInfoOuterClass.AbilityGadgetInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          StatueGadgetInfoOuterClass.StatueGadgetInfo, StatueGadgetInfoOuterClass.StatueGadgetInfo.Builder, StatueGadgetInfoOuterClass.StatueGadgetInfoOrBuilder> statueGadgetBuilder_;
      /**
       * <code>.StatueGadgetInfo statue_gadget = 19;</code>
       * @return Whether the statueGadget field is set.
       */
      ...
      public Builder setStatueGadget(
          StatueGadgetInfoOuterClass.StatueGadgetInfo.Builder builderForValue) {
        if (statueGadgetBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeStatueGadget(StatueGadgetInfoOuterClass.StatueGadgetInfo value) {
        if (statueGadgetBuilder_ == null) {
          if (contentCase_ == 19 &&
              content_ != StatueGadgetInfoOuterClass.StatueGadgetInfo.getDefaultInstance()) {
            content_ = StatueGadgetInfoOuterClass.StatueGadgetInfo.newBuilder((StatueGadgetInfoOuterClass.StatueGadgetInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          StatueGadgetInfoOuterClass.StatueGadgetInfo, StatueGadgetInfoOuterClass.StatueGadgetInfo.Builder, StatueGadgetInfoOuterClass.StatueGadgetInfoOrBuilder>
          getStatueGadgetFieldBuilder() {
        if (statueGadgetBuilder_ == null) {
          if (!(contentCase_ == 19)) {
            content_ = StatueGadgetInfoOuterClass.StatueGadgetInfo.getDefaultInstance();
          }
          statueGadgetBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              StatueGadgetInfoOuterClass.StatueGadgetInfo, StatueGadgetInfoOuterClass.StatueGadgetInfo.Builder, StatueGadgetInfoOuterClass.StatueGadgetInfoOrBuilder>(
                  (StatueGadgetInfoOuterClass.StatueGadgetInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          BossChestInfoOuterClass.BossChestInfo, BossChestInfoOuterClass.BossChestInfo.Builder, BossChestInfoOuterClass.BossChestInfoOrBuilder> bossChestBuilder_;
      /**
       * <code>.BossChestInfo boss_chest = 20;</code>
       * @return Whether the bossChest field is set.
       */
      ...
      public Builder setBossChest(
          BossChestInfoOuterClass.BossChestInfo.Builder builderForValue) {
        if (bossChestBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeBossChest(BossChestInfoOuterClass.BossChestInfo value) {
        if (bossChestBuilder_ == null) {
          if (contentCase_ == 20 &&
              content_ != BossChestInfoOuterClass.BossChestInfo.getDefaultInstance()) {
            content_ = BossChestInfoOuterClass.BossChestInfo.newBuilder((BossChestInfoOuterClass.BossChestInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          BossChestInfoOuterClass.BossChestInfo, BossChestInfoOuterClass.BossChestInfo.Builder, BossChestInfoOuterClass.BossChestInfoOrBuilder>
          getBossChestFieldBuilder() {
        if (bossChestBuilder_ == null) {
          if (!(contentCase_ == 20)) {
            content_ = BossChestInfoOuterClass.BossChestInfo.getDefaultInstance();
          }
          bossChestBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              BossChestInfoOuterClass.BossChestInfo, BossChestInfoOuterClass.BossChestInfo.Builder, BossChestInfoOuterClass.BossChestInfoOrBuilder>(
                  (BossChestInfoOuterClass.BossChestInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          BlossomChestInfoOuterClass.BlossomChestInfo, BlossomChestInfoOuterClass.BlossomChestInfo.Builder, BlossomChestInfoOuterClass.BlossomChestInfoOrBuilder> blossomChestBuilder_;
      /**
       * <code>.BlossomChestInfo blossom_chest = 41;</code>
       * @return Whether the blossomChest field is set.
       */
      ...
      public Builder setBlossomChest(
          BlossomChestInfoOuterClass.BlossomChestInfo.Builder builderForValue) {
        if (blossomChestBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeBlossomChest(BlossomChestInfoOuterClass.BlossomChestInfo value) {
        if (blossomChestBuilder_ == null) {
          if (contentCase_ == 41 &&
              content_ != BlossomChestInfoOuterClass.BlossomChestInfo.getDefaultInstance()) {
            content_ = BlossomChestInfoOuterClass.BlossomChestInfo.newBuilder((BlossomChestInfoOuterClass.BlossomChestInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          BlossomChestInfoOuterClass.BlossomChestInfo, BlossomChestInfoOuterClass.BlossomChestInfo.Builder, BlossomChestInfoOuterClass.BlossomChestInfoOrBuilder>
          getBlossomChestFieldBuilder() {
        if (blossomChestBuilder_ == null) {
          if (!(contentCase_ == 41)) {
            content_ = BlossomChestInfoOuterClass.BlossomChestInfo.getDefaultInstance();
          }
          blossomChestBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              BlossomChestInfoOuterClass.BlossomChestInfo, BlossomChestInfoOuterClass.BlossomChestInfo.Builder, BlossomChestInfoOuterClass.BlossomChestInfoOrBuilder>(
                  (BlossomChestInfoOuterClass.BlossomChestInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          MpPlayRewardInfoOuterClass.MpPlayRewardInfo, MpPlayRewardInfoOuterClass.MpPlayRewardInfo.Builder, MpPlayRewardInfoOuterClass.MpPlayRewardInfoOrBuilder> mpPlayRewardBuilder_;
      /**
       * <code>.MpPlayRewardInfo mp_play_reward = 42;</code>
       * @return Whether the mpPlayReward field is set.
       */
      ...
      public Builder setMpPlayReward(
          MpPlayRewardInfoOuterClass.MpPlayRewardInfo.Builder builderForValue) {
        if (mpPlayRewardBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeMpPlayReward(MpPlayRewardInfoOuterClass.MpPlayRewardInfo value) {
        if (mpPlayRewardBuilder_ == null) {
          if (contentCase_ == 42 &&
              content_ != MpPlayRewardInfoOuterClass.MpPlayRewardInfo.getDefaultInstance()) {
            content_ = MpPlayRewardInfoOuterClass.MpPlayRewardInfo.newBuilder((MpPlayRewardInfoOuterClass.MpPlayRewardInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          MpPlayRewardInfoOuterClass.MpPlayRewardInfo, MpPlayRewardInfoOuterClass.MpPlayRewardInfo.Builder, MpPlayRewardInfoOuterClass.MpPlayRewardInfoOrBuilder>
          getMpPlayRewardFieldBuilder() {
        if (mpPlayRewardBuilder_ == null) {
          if (!(contentCase_ == 42)) {
            content_ = MpPlayRewardInfoOuterClass.MpPlayRewardInfo.getDefaultInstance();
          }
          mpPlayRewardBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              MpPlayRewardInfoOuterClass.MpPlayRewardInfo, MpPlayRewardInfoOuterClass.MpPlayRewardInfo.Builder, MpPlayRewardInfoOuterClass.MpPlayRewardInfoOrBuilder>(
                  (MpPlayRewardInfoOuterClass.MpPlayRewardInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo, GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.Builder, GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfoOrBuilder> generalRewardBuilder_;
      /**
       * <code>.GadgetGeneralRewardInfo general_reward = 43;</code>
       * @return Whether the generalReward field is set.
       */
      ...
      public Builder setGeneralReward(
          GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.Builder builderForValue) {
        if (generalRewardBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeGeneralReward(GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo value) {
        if (generalRewardBuilder_ == null) {
          if (contentCase_ == 43 &&
              content_ != GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.getDefaultInstance()) {
            content_ = GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.newBuilder((GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (generalRewardBuilder_ == null) {
          ...
          generalRewardBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo, GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.Builder, GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfoOrBuilder>(
                  (GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeOfferingInfo(OfferingInfoOuterClass.OfferingInfo value) {
        if (offeringInfoBuilder_ == null) {
          if (contentCase_ == 44 &&
              content_ != OfferingInfoOuterClass.OfferingInfo.getDefaultInstance()) {
            content_ = OfferingInfoOuterClass.OfferingInfo.newBuilder((OfferingInfoOuterClass.OfferingInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (offeringInfoBuilder_ == null) {
          ...
          offeringInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              OfferingInfoOuterClass.OfferingInfo, OfferingInfoOuterClass.OfferingInfo.Builder, OfferingInfoOuterClass.OfferingInfoOrBuilder>(
                  (OfferingInfoOuterClass.OfferingInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeFoundationInfo(FoundationInfoOuterClass.FoundationInfo value) {
        if (foundationInfoBuilder_ == null) {
          if (contentCase_ == 45 &&
              content_ != FoundationInfoOuterClass.FoundationInfo.getDefaultInstance()) {
            content_ = FoundationInfoOuterClass.FoundationInfo.newBuilder((FoundationInfoOuterClass.FoundationInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (foundationInfoBuilder_ == null) {
          ...
          foundationInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              FoundationInfoOuterClass.FoundationInfo, FoundationInfoOuterClass.FoundationInfo.Builder, FoundationInfoOuterClass.FoundationInfoOrBuilder>(
                  (FoundationInfoOuterClass.FoundationInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeVehicleInfo(VehicleInfoOuterClass.VehicleInfo value) {
        if (vehicleInfoBuilder_ == null) {
          if (contentCase_ == 46 &&
              content_ != VehicleInfoOuterClass.VehicleInfo.getDefaultInstance()) {
            content_ = VehicleInfoOuterClass.VehicleInfo.newBuilder((VehicleInfoOuterClass.VehicleInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (vehicleInfoBuilder_ == null) {
          ...
          vehicleInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              VehicleInfoOuterClass.VehicleInfo, VehicleInfoOuterClass.VehicleInfo.Builder, VehicleInfoOuterClass.VehicleInfoOrBuilder>(
                  (VehicleInfoOuterClass.VehicleInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          EchoShellInfoOuterClass.EchoShellInfo, EchoShellInfoOuterClass.EchoShellInfo.Builder, EchoShellInfoOuterClass.EchoShellInfoOrBuilder> shellInfoBuilder_;
      /**
       * <code>.EchoShellInfo shell_info = 47;</code>
       * @return Whether the shellInfo field is set.
       */
      ...
      public Builder mergeShellInfo(EchoShellInfoOuterClass.EchoShellInfo value) {
        if (shellInfoBuilder_ == null) {
          if (contentCase_ == 47 &&
              content_ != EchoShellInfoOuterClass.EchoShellInfo.getDefaultInstance()) {
            content_ = EchoShellInfoOuterClass.EchoShellInfo.newBuilder((EchoShellInfoOuterClass.EchoShellInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (shellInfoBuilder_ == null) {
          ...
          shellInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              EchoShellInfoOuterClass.EchoShellInfo, EchoShellInfoOuterClass.EchoShellInfo.Builder, EchoShellInfoOuterClass.EchoShellInfoOrBuilder>(
                  (EchoShellInfoOuterClass.EchoShellInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeScreenInfo(ScreenInfoOuterClass.ScreenInfo value) {
        if (screenInfoBuilder_ == null) {
          if (contentCase_ == 48 &&
              content_ != ScreenInfoOuterClass.ScreenInfo.getDefaultInstance()) {
            content_ = ScreenInfoOuterClass.ScreenInfo.newBuilder((ScreenInfoOuterClass.ScreenInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (screenInfoBuilder_ == null) {
          ...
          screenInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              ScreenInfoOuterClass.ScreenInfo, ScreenInfoOuterClass.ScreenInfo.Builder, ScreenInfoOuterClass.ScreenInfoOrBuilder>(
                  (ScreenInfoOuterClass.ScreenInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeFishPoolInfo(FishPoolInfoOuterClass.FishPoolInfo value) {
        if (fishPoolInfoBuilder_ == null) {
          if (contentCase_ == 59 &&
              content_ != FishPoolInfoOuterClass.FishPoolInfo.getDefaultInstance()) {
            content_ = FishPoolInfoOuterClass.FishPoolInfo.newBuilder((FishPoolInfoOuterClass.FishPoolInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (fishPoolInfoBuilder_ == null) {
          ...
          fishPoolInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              FishPoolInfoOuterClass.FishPoolInfo, FishPoolInfoOuterClass.FishPoolInfo.Builder, FishPoolInfoOuterClass.FishPoolInfoOrBuilder>(
                  (FishPoolInfoOuterClass.FishPoolInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeCustomGadgetTreeInfo(CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo value) {
        if (customGadgetTreeInfoBuilder_ == null) {
          if (contentCase_ == 60 &&
              content_ != CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.getDefaultInstance()) {
            content_ = CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.newBuilder((CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (customGadgetTreeInfoBuilder_ == null) {
          ...
          customGadgetTreeInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo, CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo.Builder, CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfoOrBuilder>(
                  (CustomGadgetTreeInfoOuterClass.CustomGadgetTreeInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeRoguelikeGadgetInfo(RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo value) {
        if (roguelikeGadgetInfoBuilder_ == null) {
          if (contentCase_ == 61 &&
              content_ != RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo.getDefaultInstance()) {
            content_ = RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo.newBuilder((RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (roguelikeGadgetInfoBuilder_ == null) {
          ...
          roguelikeGadgetInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo, RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo.Builder, RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfoOrBuilder>(
                  (RoguelikeGadgetInfoOuterClass.RoguelikeGadgetInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeNightCrowGadgetInfo(NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo value) {
        if (nightCrowGadgetInfoBuilder_ == null) {
          if (contentCase_ == 62 &&
              content_ != NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.getDefaultInstance()) {
            content_ = NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.newBuilder((NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (nightCrowGadgetInfoBuilder_ == null) {
          ...
          nightCrowGadgetInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo, NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.Builder, NightCrowGadgetInfoOuterClass.NightCrowGadgetInfoOrBuilder>(
                  (NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeDeshretObeliskGadgetInfo(DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo value) {
        if (deshretObeliskGadgetInfoBuilder_ == null) {
          if (contentCase_ == 63 &&
              content_ != DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo.getDefaultInstance()) {
            content_ = DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo.newBuilder((DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (deshretObeliskGadgetInfoBuilder_ == null) {
          ...
          deshretObeliskGadgetInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo, DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo.Builder, DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfoOrBuilder>(
                  (DeshretObeliskGadgetInfoOuterClass.DeshretObeliskGadgetInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergeCoinCollectOperatorInfo(CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo value) {
        if (coinCollectOperatorInfoBuilder_ == null) {
          if (contentCase_ == 64 &&
              content_ != CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo.getDefaultInstance()) {
            content_ = CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo.newBuilder((CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (coinCollectOperatorInfoBuilder_ == null) {
          ...
          coinCollectOperatorInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo, CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo.Builder, CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfoOrBuilder>(
                  (CoinCollectOperatorInfoOuterClass.CoinCollectOperatorInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          TrifleGadgetOuterClass.TrifleGadget, TrifleGadgetOuterClass.TrifleGadget.Builder, TrifleGadgetOuterClass.TrifleGadgetOrBuilder> trifleGadgetBuilder_;
      /**
       * <code>.TrifleGadget trifle_gadget = 67;</code>
       * @return Whether the trifleGadget field is set.
       */
       ...
       * <code>.TrifleGadget trifle_gadget = 67;</code>
       */
      public Builder setTrifleGadget(TrifleGadgetOuterClass.TrifleGadget value) {
        if (trifleGadgetBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setTrifleGadget(
          TrifleGadgetOuterClass.TrifleGadget.Builder builderForValue) {
        if (trifleGadgetBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>.TrifleGadget trifle_gadget = 67;</code>
       */
      public Builder mergeTrifleGadget(TrifleGadgetOuterClass.TrifleGadget value) {
        if (trifleGadgetBuilder_ == null) {
          if (contentCase_ == 67 &&
              content_ != TrifleGadgetOuterClass.TrifleGadget.getDefaultInstance()) {
            content_ = TrifleGadgetOuterClass.TrifleGadget.newBuilder((TrifleGadgetOuterClass.TrifleGadget) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       * <code>.TrifleGadget trifle_gadget = 67;</code>
       */
      public TrifleGadgetOuterClass.TrifleGadget.Builder getTrifleGadgetBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          TrifleGadgetOuterClass.TrifleGadget, TrifleGadgetOuterClass.TrifleGadget.Builder, TrifleGadgetOuterClass.TrifleGadgetOrBuilder>
          getTrifleGadgetFieldBuilder() {
        if (trifleGadgetBuilder_ == null) {
          if (!(contentCase_ == 67)) {
            content_ = TrifleGadgetOuterClass.TrifleGadget.getDefaultInstance();
          }
          trifleGadgetBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              TrifleGadgetOuterClass.TrifleGadget, TrifleGadgetOuterClass.TrifleGadget.Builder, TrifleGadgetOuterClass.TrifleGadgetOrBuilder>(
                  (TrifleGadgetOuterClass.TrifleGadget) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      public Builder mergePlatform(PlatformInfoOuterClass.PlatformInfo value) {
        if (platformBuilder_ == null) {
          if (((bitField1_ & 0x00000008) != 0) &&
            platform_ != null &&
            platform_ != PlatformInfoOuterClass.PlatformInfo.getDefaultInstance()) {
      ...
      private JMFPBNKNHEDOuterClass.JMFPBNKNHED gPOHBBPBBEC_;
      private com.google.protobuf.SingleFieldBuilder<
          JMFPBNKNHEDOuterClass.JMFPBNKNHED, JMFPBNKNHEDOuterClass.JMFPBNKNHED.Builder, JMFPBNKNHEDOuterClass.JMFPBNKNHEDOrBuilder> gPOHBBPBBECBuilder_;
      /**
       * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
       * @return Whether the gPOHBBPBBEC field is set.
       */
       ...
       * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
       */
      public Builder setGPOHBBPBBEC(JMFPBNKNHEDOuterClass.JMFPBNKNHED value) {
        if (gPOHBBPBBECBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setGPOHBBPBBEC(
          JMFPBNKNHEDOuterClass.JMFPBNKNHED.Builder builderForValue) {
        if (gPOHBBPBBECBuilder_ == null) {
       ...
       * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
       */
      public Builder mergeGPOHBBPBBEC(JMFPBNKNHEDOuterClass.JMFPBNKNHED value) {
        if (gPOHBBPBBECBuilder_ == null) {
          if (((bitField1_ & 0x00000080) != 0) &&
            gPOHBBPBBEC_ != null &&
            gPOHBBPBBEC_ != JMFPBNKNHEDOuterClass.JMFPBNKNHED.getDefaultInstance()) {
       ...
       * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
       */
      public JMFPBNKNHEDOuterClass.JMFPBNKNHED.Builder getGPOHBBPBBECBuilder() {
        bitField1_ |= 0x00000080;
        onChanged();
      ...
      public JMFPBNKNHEDOuterClass.JMFPBNKNHEDOrBuilder getGPOHBBPBBECOrBuilder() {
        if (gPOHBBPBBECBuilder_ != null) {
          ...
          return gPOHBBPBBEC_ == null ?
              JMFPBNKNHEDOuterClass.JMFPBNKNHED.getDefaultInstance() : gPOHBBPBBEC_;
        }
      }
      /**
       * <code>.JMFPBNKNHED GPOHBBPBBEC = 27;</code>
       */
      private com.google.protobuf.SingleFieldBuilder<
          JMFPBNKNHEDOuterClass.JMFPBNKNHED, JMFPBNKNHEDOuterClass.JMFPBNKNHED.Builder, JMFPBNKNHEDOuterClass.JMFPBNKNHEDOrBuilder>
          getGPOHBBPBBECFieldBuilder() {
        if (gPOHBBPBBECBuilder_ == null) {
          gPOHBBPBBECBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              JMFPBNKNHEDOuterClass.JMFPBNKNHED, JMFPBNKNHEDOuterClass.JMFPBNKNHED.Builder, JMFPBNKNHEDOuterClass.JMFPBNKNHEDOrBuilder>(
                  getGPOHBBPBBEC(),
                  getParentForChildren(),
                  isClean());
      ...
      public Builder mergePlayInfo(GadgetPlayInfoOuterClass.GadgetPlayInfo value) {
        if (playInfoBuilder_ == null) {
          if (((bitField1_ & 0x00000100) != 0) &&
            playInfo_ != null &&
            playInfo_ != GadgetPlayInfoOuterClass.GadgetPlayInfo.getDefaultInstance()) {
      ...
      private GDGKKLFMJKHOuterClass.GDGKKLFMJKH dPJFGJDHGGJ_;
      private com.google.protobuf.SingleFieldBuilder<
          GDGKKLFMJKHOuterClass.GDGKKLFMJKH, GDGKKLFMJKHOuterClass.GDGKKLFMJKH.Builder, GDGKKLFMJKHOuterClass.GDGKKLFMJKHOrBuilder> dPJFGJDHGGJBuilder_;
      /**
       * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
       * @return Whether the dPJFGJDHGGJ field is set.
       */
       ...
       * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
       */
      public Builder setDPJFGJDHGGJ(GDGKKLFMJKHOuterClass.GDGKKLFMJKH value) {
        if (dPJFGJDHGGJBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setDPJFGJDHGGJ(
          GDGKKLFMJKHOuterClass.GDGKKLFMJKH.Builder builderForValue) {
        if (dPJFGJDHGGJBuilder_ == null) {
       ...
       * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
       */
      public Builder mergeDPJFGJDHGGJ(GDGKKLFMJKHOuterClass.GDGKKLFMJKH value) {
        if (dPJFGJDHGGJBuilder_ == null) {
          if (((bitField1_ & 0x00000200) != 0) &&
            dPJFGJDHGGJ_ != null &&
            dPJFGJDHGGJ_ != GDGKKLFMJKHOuterClass.GDGKKLFMJKH.getDefaultInstance()) {
       ...
       * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
       */
      public GDGKKLFMJKHOuterClass.GDGKKLFMJKH.Builder getDPJFGJDHGGJBuilder() {
        bitField1_ |= 0x00000200;
        onChanged();
      ...
      public GDGKKLFMJKHOuterClass.GDGKKLFMJKHOrBuilder getDPJFGJDHGGJOrBuilder() {
        if (dPJFGJDHGGJBuilder_ != null) {
          ...
          return dPJFGJDHGGJ_ == null ?
              GDGKKLFMJKHOuterClass.GDGKKLFMJKH.getDefaultInstance() : dPJFGJDHGGJ_;
        }
      }
      /**
       * <code>.GDGKKLFMJKH DPJFGJDHGGJ = 101;</code>
       */
      private com.google.protobuf.SingleFieldBuilder<
          GDGKKLFMJKHOuterClass.GDGKKLFMJKH, GDGKKLFMJKHOuterClass.GDGKKLFMJKH.Builder, GDGKKLFMJKHOuterClass.GDGKKLFMJKHOrBuilder>
          getDPJFGJDHGGJFieldBuilder() {
        if (dPJFGJDHGGJBuilder_ == null) {
          dPJFGJDHGGJBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              GDGKKLFMJKHOuterClass.GDGKKLFMJKH, GDGKKLFMJKHOuterClass.GDGKKLFMJKH.Builder, GDGKKLFMJKHOuterClass.GDGKKLFMJKHOrBuilder>(
                  getDPJFGJDHGGJ(),
                  getParentForChildren(),
                  isClean());
      ...
      private OMBIJJLAHFBOuterClass.OMBIJJLAHFB pBBAFKFGHIB_;
      private com.google.protobuf.SingleFieldBuilder<
          OMBIJJLAHFBOuterClass.OMBIJJLAHFB, OMBIJJLAHFBOuterClass.OMBIJJLAHFB.Builder, OMBIJJLAHFBOuterClass.OMBIJJLAHFBOrBuilder> pBBAFKFGHIBBuilder_;
      /**
       * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
       * @return Whether the pBBAFKFGHIB field is set.
       */
       ...
       * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
       */
      public Builder setPBBAFKFGHIB(OMBIJJLAHFBOuterClass.OMBIJJLAHFB value) {
        if (pBBAFKFGHIBBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setPBBAFKFGHIB(
          OMBIJJLAHFBOuterClass.OMBIJJLAHFB.Builder builderForValue) {
        if (pBBAFKFGHIBBuilder_ == null) {
       ...
       * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
       */
      public Builder mergePBBAFKFGHIB(OMBIJJLAHFBOuterClass.OMBIJJLAHFB value) {
        if (pBBAFKFGHIBBuilder_ == null) {
          if (((bitField1_ & 0x00000400) != 0) &&
            pBBAFKFGHIB_ != null &&
            pBBAFKFGHIB_ != OMBIJJLAHFBOuterClass.OMBIJJLAHFB.getDefaultInstance()) {
       ...
       * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
       */
      public OMBIJJLAHFBOuterClass.OMBIJJLAHFB.Builder getPBBAFKFGHIBBuilder() {
        bitField1_ |= 0x00000400;
        onChanged();
      ...
      public OMBIJJLAHFBOuterClass.OMBIJJLAHFBOrBuilder getPBBAFKFGHIBOrBuilder() {
        if (pBBAFKFGHIBBuilder_ != null) {
          ...
          return pBBAFKFGHIB_ == null ?
              OMBIJJLAHFBOuterClass.OMBIJJLAHFB.getDefaultInstance() : pBBAFKFGHIB_;
        }
      }
      /**
       * <code>.OMBIJJLAHFB PBBAFKFGHIB = 102;</code>
       */
      private com.google.protobuf.SingleFieldBuilder<
          OMBIJJLAHFBOuterClass.OMBIJJLAHFB, OMBIJJLAHFBOuterClass.OMBIJJLAHFB.Builder, OMBIJJLAHFBOuterClass.OMBIJJLAHFBOrBuilder>
          getPBBAFKFGHIBFieldBuilder() {
        if (pBBAFKFGHIBBuilder_ == null) {
          pBBAFKFGHIBBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              OMBIJJLAHFBOuterClass.OMBIJJLAHFB, OMBIJJLAHFBOuterClass.OMBIJJLAHFB.Builder, OMBIJJLAHFBOuterClass.OMBIJJLAHFBOrBuilder>(
                  getPBBAFKFGHIB(),
                  getParentForChildren(),
                  isClean());
      ...
      private BDOCPDNCIEFOuterClass.BDOCPDNCIEF fDKBHOCNBPH_;
      private com.google.protobuf.SingleFieldBuilder<
          BDOCPDNCIEFOuterClass.BDOCPDNCIEF, BDOCPDNCIEFOuterClass.BDOCPDNCIEF.Builder, BDOCPDNCIEFOuterClass.BDOCPDNCIEFOrBuilder> fDKBHOCNBPHBuilder_;
      /**
       * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
       * @return Whether the fDKBHOCNBPH field is set.
       */
       ...
       * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
       */
      public Builder setFDKBHOCNBPH(BDOCPDNCIEFOuterClass.BDOCPDNCIEF value) {
        if (fDKBHOCNBPHBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFDKBHOCNBPH(
          BDOCPDNCIEFOuterClass.BDOCPDNCIEF.Builder builderForValue) {
        if (fDKBHOCNBPHBuilder_ == null) {
       ...
       * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
       */
      public Builder mergeFDKBHOCNBPH(BDOCPDNCIEFOuterClass.BDOCPDNCIEF value) {
        if (fDKBHOCNBPHBuilder_ == null) {
          if (((bitField1_ & 0x00000800) != 0) &&
            fDKBHOCNBPH_ != null &&
            fDKBHOCNBPH_ != BDOCPDNCIEFOuterClass.BDOCPDNCIEF.getDefaultInstance()) {
       ...
       * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
       */
      public BDOCPDNCIEFOuterClass.BDOCPDNCIEF.Builder getFDKBHOCNBPHBuilder() {
        bitField1_ |= 0x00000800;
        onChanged();
      ...
      public BDOCPDNCIEFOuterClass.BDOCPDNCIEFOrBuilder getFDKBHOCNBPHOrBuilder() {
        if (fDKBHOCNBPHBuilder_ != null) {
          ...
          return fDKBHOCNBPH_ == null ?
              BDOCPDNCIEFOuterClass.BDOCPDNCIEF.getDefaultInstance() : fDKBHOCNBPH_;
        }
      }
      /**
       * <code>.BDOCPDNCIEF FDKBHOCNBPH = 103;</code>
       */
      private com.google.protobuf.SingleFieldBuilder<
          BDOCPDNCIEFOuterClass.BDOCPDNCIEF, BDOCPDNCIEFOuterClass.BDOCPDNCIEF.Builder, BDOCPDNCIEFOuterClass.BDOCPDNCIEFOrBuilder>
          getFDKBHOCNBPHFieldBuilder() {
        if (fDKBHOCNBPHBuilder_ == null) {
          fDKBHOCNBPHBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              BDOCPDNCIEFOuterClass.BDOCPDNCIEF, BDOCPDNCIEFOuterClass.BDOCPDNCIEF.Builder, BDOCPDNCIEFOuterClass.BDOCPDNCIEFOrBuilder>(
                  getFDKBHOCNBPH(),
                  getParentForChildren(),
                  isClean());
  ...
  static {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          TrifleGadgetOuterClass.getDescriptor(),
          PlatformInfoOuterClass.getDescriptor(),
          JMFPBNKNHEDOuterClass.getDescriptor(),
          GadgetPlayInfoOuterClass.getDescriptor(),
          GDGKKLFMJKHOuterClass.getDescriptor(),
          OMBIJJLAHFBOuterClass.getDescriptor(),
          BDOCPDNCIEFOuterClass.getDescriptor(),
        });
    internal_static_SceneGadgetInfo_descriptor =
    ...
    internal_static_SceneGadgetInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_SceneGadgetInfo_descriptor,
        new String[] { "GadgetId", "GroupId", "ConfigId", "OwnerEntityId", "BornType", "GadgetState", "KPKNNJLPMFP", "IsShowCutscene", "AuthorityPeerId", "IsEnableInteract", "CLICILNBKDD", "GatherGadget", "Worktop", "ClientGadget", "Weather", "AbilityGadget", "StatueGadget", "BossChest", "BlossomChest", "MpPlayReward", "GeneralReward", "OfferingInfo", "FoundationInfo", "VehicleInfo", "ShellInfo", "ScreenInfo", "FishPoolInfo", "CustomGadgetTreeInfo", "RoguelikeGadgetInfo", "NightCrowGadgetInfo", "DeshretObeliskGadgetInfo", "CoinCollectOperatorInfo", "TrifleGadget", "MarkFlag", "PropOwnerEntityId", "Platform", "InteractUidList", "DraftId", "KHICBPFFAII", "GPOHBBPBBEC", "PlayInfo", "DPJFGJDHGGJ", "PBBAFKFGHIB", "FDKBHOCNBPH", "Content", });
