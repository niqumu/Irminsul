...
public final class PropValueOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      PropValueOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final Object obj) {
      ...
      switch (valueCase_) {
        case 2:
          ...
          break;
        case 3:
          if (Float.floatToIntBits(getFval())
    ...
    public static PropValue parseFrom(
    ...
    public static PropValue parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PropValue parseFrom(
    ...
    public static PropValue parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PropValue parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static PropValue parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.PropValueOuterClass.PropValue.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(PropValue result) {
      ...
      private void buildPartialOneofs(PropValue result) {
      ...
      public Builder mergeFrom(PropValue other) {
        if (other == PropValue.getDefaultInstance()) return this;
        if (other.getType() != 0) {
  ...
  static {
    ...
    internal_static_PropValue_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_PropValue_descriptor,
        new String[] { "Type", "Ival", "Fval", "Val", "Value", });
