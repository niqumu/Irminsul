...
public final class BreakoutPhysicalObjectModifierOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      BreakoutPhysicalObjectModifierOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        BreakoutPhysicalObjectModifier.class.getName());
    }
    // Use BreakoutPhysicalObjectModifier.newBuilder() to construct.
    private BreakoutPhysicalObjectModifier(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return BreakoutPhysicalObjectModifierOuterClass.internal_static_BreakoutPhysicalObjectModifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BreakoutPhysicalObjectModifier.class, Builder.class);
    }
    ...
    public static BreakoutPhysicalObjectModifier parseFrom(
    ...
    public static BreakoutPhysicalObjectModifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BreakoutPhysicalObjectModifier parseFrom(
    ...
    public static BreakoutPhysicalObjectModifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BreakoutPhysicalObjectModifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static BreakoutPhysicalObjectModifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(BreakoutPhysicalObjectModifier result) {
      ...
      public Builder mergeFrom(BreakoutPhysicalObjectModifier other) {
        if (other == BreakoutPhysicalObjectModifier.getDefaultInstance()) return this;
        if (other.getType() != 0) {
    ...
    private static final BreakoutPhysicalObjectModifier DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BreakoutPhysicalObjectModifier();
    }
  ...
  static {
    String[] descriptorData = {
      ...
      "ose_player_count\030\020 \001(\rB\032\n\030io.irminsul.co" +
    ...
    internal_static_BreakoutPhysicalObjectModifier_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_BreakoutPhysicalObjectModifier_descriptor,
        new String[] { "Type", "Id", "Param1", "Param2", "Param3", "Param4", "Param5", "Param6", "Bool1", "Duration", "EndTime", "Combo", "PeerId", "SkillType", "Level", "ChoosePlayerCount", });
