...
public final class BreakoutPhysicalObjectOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      BreakoutPhysicalObjectOuterClass.class.getName());
  }
  ...
  public interface BreakoutPhysicalObjectOrBuilder extends
     ...
     * <code>repeated .BreakoutPhysicalObjectModifier modifier_list = 11;</code>
     */
    BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier getModifierList(int index);
    /**
     * <code>repeated .BreakoutPhysicalObjectModifier modifier_list = 11;</code>
     */
     ...
     * <code>repeated .BreakoutPhysicalObjectModifier modifier_list = 11;</code>
     */
    BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifierOrBuilder getModifierListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        BreakoutPhysicalObject.class.getName());
    }
    // Use BreakoutPhysicalObject.newBuilder() to construct.
    private BreakoutPhysicalObject(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return BreakoutPhysicalObjectOuterClass.internal_static_BreakoutPhysicalObject_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BreakoutPhysicalObject.class, Builder.class);
    }
    ...
    public BreakoutVector2OuterClass.BreakoutVector2 getMoveDir() {
      return moveDir_ == null ? BreakoutVector2OuterClass.BreakoutVector2.getDefaultInstance() : moveDir_;
    }
    /**
     * <code>.BreakoutVector2 move_dir = 5;</code>
     */
    ...
    private java.util.List<BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier> modifierList_;
    /**
     * <code>repeated .BreakoutPhysicalObjectModifier modifier_list = 11;</code>
     */
    @Override
    public java.util.List<BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier> getModifierListList() {
     ...
     */
    @Override
    public BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifierOrBuilder getModifierListOrBuilder(
        int index) {
      return modifierList_.get(index);
    }
    ...
    public static BreakoutPhysicalObject parseFrom(
    ...
    public static BreakoutPhysicalObject parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BreakoutPhysicalObject parseFrom(
    ...
    public static BreakoutPhysicalObject parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BreakoutPhysicalObject parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static BreakoutPhysicalObject parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.BreakoutPhysicalObjectOuterClass.BreakoutPhysicalObject.newBuilder()
      private Builder() {
      ...
      private void buildPartialRepeatedFields(BreakoutPhysicalObject result) {
        if (modifierListBuilder_ == null) {
      ...
      private void buildPartial0(BreakoutPhysicalObject result) {
      ...
      public Builder mergeFrom(BreakoutPhysicalObject other) {
        if (other == BreakoutPhysicalObject.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
        if (other.getIndex() != 0) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 90: {
                BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier m =
                    input.readMessage(
                        BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.parser(),
                        extensionRegistry);
                if (modifierListBuilder_ == null) {
                  ensureModifierListIsMutable();
                  modifierList_.add(m);
              ...
              case 106: {
                BreakoutBrickInfoOuterClass.BreakoutBrickInfo m =
                    input.readMessage(
                        BreakoutBrickInfoOuterClass.BreakoutBrickInfo.parser(),
                        extensionRegistry);
                if (infoListBuilder_ == null) {
                  ensureInfoListIsMutable();
                  infoList_.add(m);
      ...
      public Builder mergePos(BreakoutVector2OuterClass.BreakoutVector2 value) {
        if (posBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0) &&
            pos_ != null &&
            pos_ != BreakoutVector2OuterClass.BreakoutVector2.getDefaultInstance()) {
      ...
      private BreakoutVector2OuterClass.BreakoutVector2 moveDir_;
      private com.google.protobuf.SingleFieldBuilder<
          BreakoutVector2OuterClass.BreakoutVector2, BreakoutVector2OuterClass.BreakoutVector2.Builder, BreakoutVector2OuterClass.BreakoutVector2OrBuilder> moveDirBuilder_;
      /**
       * <code>.BreakoutVector2 move_dir = 5;</code>
       * @return Whether the moveDir field is set.
       */
      ...
      public Builder mergeMoveDir(BreakoutVector2OuterClass.BreakoutVector2 value) {
        if (moveDirBuilder_ == null) {
          if (((bitField0_ & 0x00000010) != 0) &&
            moveDir_ != null &&
            moveDir_ != BreakoutVector2OuterClass.BreakoutVector2.getDefaultInstance()) {
      ...
      public BreakoutVector2OuterClass.BreakoutVector2OrBuilder getMoveDirOrBuilder() {
        if (moveDirBuilder_ != null) {
          ...
          return moveDir_ == null ?
              BreakoutVector2OuterClass.BreakoutVector2.getDefaultInstance() : moveDir_;
        }
      }
      /**
       * <code>.BreakoutVector2 move_dir = 5;</code>
      ...
      private void ensureModifierListIsMutable() {
        if (!((bitField0_ & 0x00000400) != 0)) {
          modifierList_ = new java.util.ArrayList<BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier>(modifierList_);
          bitField0_ |= 0x00000400;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier, BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.Builder, BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifierOrBuilder> modifierListBuilder_;
      ...
      public Builder addAllModifierList(
          Iterable<? extends BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier> values) {
        if (modifierListBuilder_ == null) {
          ensureModifierListIsMutable();
       ...
       * <code>repeated .BreakoutPhysicalObjectModifier modifier_list = 11;</code>
       */
      public BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.Builder getModifierListBuilder(
          int index) {
      ...
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          getModifierListFieldBuilder() {
        if (modifierListBuilder_ == null) {
          modifierListBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier, BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.Builder, BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifierOrBuilder>(
                  modifierList_,
      ...
      public Builder addAllInfoList(
          Iterable<? extends BreakoutBrickInfoOuterClass.BreakoutBrickInfo> values) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, infoList_);
    ...
    private static final BreakoutPhysicalObject DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BreakoutPhysicalObject();
    }
  ...
  static {
    ...
    internal_static_BreakoutPhysicalObject_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_BreakoutPhysicalObject_descriptor,
        new String[] { "Id", "Index", "IsActive", "Pos", "MoveDir", "Speed", "InitPeerId", "State", "ElementType", "ElementReactionBuff", "ModifierList", "TotalRotation", "InfoList", "LastHitPeerId", "SpeedIncreaseCount", "Offset", });
