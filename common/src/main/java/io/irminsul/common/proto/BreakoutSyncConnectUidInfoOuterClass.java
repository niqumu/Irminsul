...
public final class BreakoutSyncConnectUidInfoOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      BreakoutSyncConnectUidInfoOuterClass.class.getName());
  }
  ...
  public interface BreakoutSyncConnectUidInfoOrBuilder extends
     ...
     */
    java.util.List<Integer> getSkillLevelListList();
    /**
     * <code>repeated uint32 skill_level_list = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        BreakoutSyncConnectUidInfo.class.getName());
    }
    // Use BreakoutSyncConnectUidInfo.newBuilder() to construct.
    private BreakoutSyncConnectUidInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return BreakoutSyncConnectUidInfoOuterClass.internal_static_BreakoutSyncConnectUidInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              BreakoutSyncConnectUidInfo.class, Builder.class);
    }
    ...
    public static BreakoutSyncConnectUidInfo parseFrom(
    ...
    public static BreakoutSyncConnectUidInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static BreakoutSyncConnectUidInfo parseFrom(
    ...
    public static BreakoutSyncConnectUidInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static BreakoutSyncConnectUidInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static BreakoutSyncConnectUidInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(BreakoutSyncConnectUidInfo result) {
      ...
      public Builder mergeFrom(BreakoutSyncConnectUidInfo other) {
        if (other == BreakoutSyncConnectUidInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
      ...
      private void ensureSkillLevelListIsMutable() {
        if (!skillLevelList_.isModifiable()) {
          skillLevelList_ = makeMutableCopy(skillLevelList_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
    ...
    private static final BreakoutSyncConnectUidInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new BreakoutSyncConnectUidInfo();
    }
  ...
  static {
    ...
    internal_static_BreakoutSyncConnectUidInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_BreakoutSyncConnectUidInfo_descriptor,
        new String[] { "Uid", "SkillIdList", "SkillLevelList", });
