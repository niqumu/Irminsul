...
public final class SkipPlayerGameTimeRspOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      SkipPlayerGameTimeRspOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        SkipPlayerGameTimeRsp.class.getName());
    }
    // Use SkipPlayerGameTimeRsp.newBuilder() to construct.
    private SkipPlayerGameTimeRsp(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return SkipPlayerGameTimeRspOuterClass.internal_static_SkipPlayerGameTimeRsp_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return SkipPlayerGameTimeRspOuterClass.internal_static_SkipPlayerGameTimeRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SkipPlayerGameTimeRsp.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof SkipPlayerGameTimeRsp)) {
        return super.equals(obj);
      }
      SkipPlayerGameTimeRsp other = (SkipPlayerGameTimeRsp) obj;
    ...
    public static SkipPlayerGameTimeRsp parseFrom(
    ...
    public static SkipPlayerGameTimeRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SkipPlayerGameTimeRsp parseFrom(
    ...
    public static SkipPlayerGameTimeRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SkipPlayerGameTimeRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static SkipPlayerGameTimeRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static Builder newBuilder(SkipPlayerGameTimeRsp prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.SkipPlayerGameTimeRspOuterClass.SkipPlayerGameTimeRsp.newBuilder()
      private Builder() {
      ...
      @Override
      public SkipPlayerGameTimeRsp getDefaultInstanceForType() {
        return SkipPlayerGameTimeRsp.getDefaultInstance();
      }

      @Override
      public SkipPlayerGameTimeRsp build() {
        SkipPlayerGameTimeRsp result = buildPartial();
      ...
      @Override
      public SkipPlayerGameTimeRsp buildPartial() {
        SkipPlayerGameTimeRsp result = new SkipPlayerGameTimeRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(SkipPlayerGameTimeRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SkipPlayerGameTimeRsp) {
          return mergeFrom((SkipPlayerGameTimeRsp)other);
        } else {
      ...
      public Builder mergeFrom(SkipPlayerGameTimeRsp other) {
        if (other == SkipPlayerGameTimeRsp.getDefaultInstance()) return this;
    ...
    private static final SkipPlayerGameTimeRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SkipPlayerGameTimeRsp();
    }

    public static SkipPlayerGameTimeRsp getDefaultInstance() {
  ...
  static {
    ...
    internal_static_SkipPlayerGameTimeRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_SkipPlayerGameTimeRsp_descriptor,
        new String[] { "ClientGameTime", "Retcode", "GameTime", });
