...
public final class EvtAvatarLockChairRspOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      EvtAvatarLockChairRspOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        EvtAvatarLockChairRsp.class.getName());
    }
    // Use EvtAvatarLockChairRsp.newBuilder() to construct.
    private EvtAvatarLockChairRsp(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return EvtAvatarLockChairRspOuterClass.internal_static_EvtAvatarLockChairRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EvtAvatarLockChairRsp.class, Builder.class);
    }
    ...
    public static EvtAvatarLockChairRsp parseFrom(
    ...
    public static EvtAvatarLockChairRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EvtAvatarLockChairRsp parseFrom(
    ...
    public static EvtAvatarLockChairRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EvtAvatarLockChairRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static EvtAvatarLockChairRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(EvtAvatarLockChairRsp result) {
      ...
      public Builder mergeFrom(EvtAvatarLockChairRsp other) {
        if (other == EvtAvatarLockChairRsp.getDefaultInstance()) return this;
  ...
  static {
    ...
    internal_static_EvtAvatarLockChairRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_EvtAvatarLockChairRsp_descriptor,
        new String[] { "ChairId", "Position", "Retcode", "EntityId", "Direction", });
