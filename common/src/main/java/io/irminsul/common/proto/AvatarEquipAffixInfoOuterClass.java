...
public final class AvatarEquipAffixInfoOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      AvatarEquipAffixInfoOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        AvatarEquipAffixInfo.class.getName());
    }
    // Use AvatarEquipAffixInfo.newBuilder() to construct.
    private AvatarEquipAffixInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return AvatarEquipAffixInfoOuterClass.internal_static_AvatarEquipAffixInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AvatarEquipAffixInfo.class, Builder.class);
    }
    ...
    public static AvatarEquipAffixInfo parseFrom(
    ...
    public static AvatarEquipAffixInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static AvatarEquipAffixInfo parseFrom(
    ...
    public static AvatarEquipAffixInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AvatarEquipAffixInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static AvatarEquipAffixInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(AvatarEquipAffixInfo result) {
      ...
      public Builder mergeFrom(AvatarEquipAffixInfo other) {
        if (other == AvatarEquipAffixInfo.getDefaultInstance()) return this;
    ...
    private static final AvatarEquipAffixInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AvatarEquipAffixInfo();
    }
  ...
  static {
    String[] descriptorData = {
      ...
      "left_cd_time\030\002 \001(\rB\032\n\030io.irminsul.common" +
      ".protob\006proto3"
    };
    ...
    internal_static_AvatarEquipAffixInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_AvatarEquipAffixInfo_descriptor,
        new String[] { "EquipAffixId", "LeftCdTime", });
