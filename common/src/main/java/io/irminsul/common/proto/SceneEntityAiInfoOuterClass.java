...
public final class SceneEntityAiInfoOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      SceneEntityAiInfoOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        SceneEntityAiInfo.class.getName());
    }
    // Use SceneEntityAiInfo.newBuilder() to construct.
    private SceneEntityAiInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return SceneEntityAiInfoOuterClass.internal_static_SceneEntityAiInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SceneEntityAiInfo.class, Builder.class);
    }
    ...
    @Override
    @Deprecated
    public java.util.Map<Integer, Integer> getSkillCdMap() {
     ...
     */
    @Override
    public java.util.Map<Integer, Integer> getSkillCdMapMap() {
    ...
    @Override
    @Deprecated
    public java.util.Map<Integer, Integer> getAiThreatMap() {
     ...
     */
    @Override
    public java.util.Map<Integer, Integer> getAiThreatMapMap() {
    ...
    @SuppressWarnings("serial")
    private com.google.protobuf.MapField<
        Integer, Integer> skillGroupCdMap_;
    private com.google.protobuf.MapField<Integer, Integer>
    ...
    @Override
    @Deprecated
    public java.util.Map<Integer, Integer> getSkillGroupCdMap() {
     ...
     */
    @Override
    public java.util.Map<Integer, Integer> getSkillGroupCdMapMap() {
    ...
    public static SceneEntityAiInfo parseFrom(
    ...
    public static SceneEntityAiInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static SceneEntityAiInfo parseFrom(
    ...
    public static SceneEntityAiInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SceneEntityAiInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static SceneEntityAiInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.SceneEntityAiInfoOuterClass.SceneEntityAiInfo.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(SceneEntityAiInfo result) {
      ...
      public Builder mergeFrom(SceneEntityAiInfo other) {
        if (other == SceneEntityAiInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeServantInfo(ServantInfoOuterClass.ServantInfo value) {
        if (servantInfoBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0) &&
            servantInfo_ != null &&
            servantInfo_ != ServantInfoOuterClass.ServantInfo.getDefaultInstance()) {
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getServantInfoFieldBuilder() {
        if (servantInfoBuilder_ == null) {
          servantInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              ServantInfoOuterClass.ServantInfo, ServantInfoOuterClass.ServantInfo.Builder, ServantInfoOuterClass.ServantInfoOrBuilder>(
                  getServantInfo(),
                  getParentForChildren(),
                  isClean());
  ...
  static {
    ...
    internal_static_SceneEntityAiInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_SceneEntityAiInfo_descriptor,
        new String[] { "IsAiOpen", "BornPos", "SkillCdMap", "ServantInfo", "AiThreatMap", "SkillGroupCdMap", "CurTactic", "NMECJFPHFGH", });
    internal_static_SceneEntityAiInfo_SkillCdMapEntry_descriptor =
