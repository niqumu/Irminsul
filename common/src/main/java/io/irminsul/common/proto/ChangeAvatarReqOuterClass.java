...
public final class ChangeAvatarReqOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      ChangeAvatarReqOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 2,
        /* suffix= */ "",
        ChangeAvatarReq.class.getName());
    }
    // Use ChangeAvatarReq.newBuilder() to construct.
    private ChangeAvatarReq(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    protected FieldAccessorTable
      ...
      return ChangeAvatarReqOuterClass.internal_static_ChangeAvatarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ChangeAvatarReq.class, Builder.class);
    }
    ...
    public VectorOuterClass.Vector getMovePos() {
      return movePos_ == null ? VectorOuterClass.Vector.getDefaultInstance() : movePos_;
    }
    /**
     * <code>.Vector move_pos = 9;</code>
     */
    ...
    public static ChangeAvatarReq parseFrom(
    ...
    public static ChangeAvatarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ChangeAvatarReq parseFrom(
    ...
    public static ChangeAvatarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ChangeAvatarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static ChangeAvatarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends
      ...
      // Construct using io.irminsul.common.proto.ChangeAvatarReqOuterClass.ChangeAvatarReq.newBuilder()
      private Builder() {
      ...
      private void buildPartial0(ChangeAvatarReq result) {
      ...
      public Builder mergeFrom(ChangeAvatarReq other) {
        if (other == ChangeAvatarReq.getDefaultInstance()) return this;
        if (other.hasMovePos()) {
      ...
      private com.google.protobuf.SingleFieldBuilder<
          VectorOuterClass.Vector, VectorOuterClass.Vector.Builder, VectorOuterClass.VectorOrBuilder> movePosBuilder_;
      /**
       * <code>.Vector move_pos = 9;</code>
       * @return Whether the movePos field is set.
       */
      ...
      public Builder mergeMovePos(VectorOuterClass.Vector value) {
        if (movePosBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            movePos_ != null &&
            movePos_ != VectorOuterClass.Vector.getDefaultInstance()) {
      ...
      public VectorOuterClass.VectorOrBuilder getMovePosOrBuilder() {
        if (movePosBuilder_ != null) {
          ...
          return movePos_ == null ?
              VectorOuterClass.Vector.getDefaultInstance() : movePos_;
        }
      }
      /**
       * <code>.Vector move_pos = 9;</code>
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getMovePosFieldBuilder() {
        if (movePosBuilder_ == null) {
          movePosBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              VectorOuterClass.Vector, VectorOuterClass.Vector.Builder, VectorOuterClass.VectorOrBuilder>(
                  getMovePos(),
    ...
    private static final ChangeAvatarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ChangeAvatarReq();
    }
  ...
  static {
    ...
    internal_static_ChangeAvatarReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_ChangeAvatarReq_descriptor,
        new String[] { "MovePos", "Guid", "IsMove", "SkillId", });
